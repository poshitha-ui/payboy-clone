            ...
            <div class="">
                ...
                <div class="bg-green-50 p-8 rounded-lg">
                    <div class="grid md:grid-cols-2 md:gap-x-12">
                        ...
                        <div class="w-full">
                            <div class="md:h-80"><img src="./../assets/images/slide2.webp" class="rounded-2xl h-full ml-auto" alt="image not found"></div>
                        </div>
                    </div>
                </div>
                <div class="mt-4">
                    <div class="grid md:grid-cols-2 gap-4">
                        <div class="w-full bg-orange-50 p-8 rounded-lg">
                            ...
                            <div class="md:h-80">
                                <img src="./../assets/images/schedule.webp" class="rounded-2xl h-full mx-auto mt-2" alt="image not found">
                            </div>
